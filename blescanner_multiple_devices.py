...
# Example scan for multiple BLE devices and parse the data published.
...
if __name__ == "__main__":
    ...
    status, devdata = ble_scanner(_TIME_OUT, _ADVDATA, _DEBUG)
    if status:
        # print(f'{devdata}')
        devices = json.loads(devdata)
        # print(f'{devices}')
        for device in devices:
            print(device['address'], device['advertisementdata'])
